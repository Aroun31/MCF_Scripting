...
*/
	...
	[] remoteExec ["DA3F_fnc_initPrice", 2];
	//[]spawn DA3F_fnc_initPrice;

	{
		_mrk = createMarker [format ["DA3F_Mrk_Parcelle_%1", _foreachindex], getMarkerPos (configName _x)];
		_mrk setMarkerShape "ICON";
		_mrk setMarkerType "hd_dot";
		_mrk setMarkerColor "colorBlue";
		_mrk setMarkerText format ["%1", getText(_x >> "displayname")];
	} forEach ("true" configClasses(missionConfigFile >> "CfgParcelle"));